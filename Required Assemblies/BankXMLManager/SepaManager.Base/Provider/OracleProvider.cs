...
namespace PetaPoco
{
    ...
    public class OracleProvider : DbProviderFactory
    {
        ...
        private const string _assemblyName = "System.Data.OracleClient";
        private const string _connectionTypeName = "System.Data.OracleClient.OracleConnection";
        private const string _commandTypeName = "System.Data.OracleClient.OracleCommand";
        ...
        public OracleProvider()
        {
            ...
            _connectionType = typeof(OracleConnection);
            _commandType = typeof(OracleCommand);
