...
{
    public class SqlCapGroupingRepo : SqlRepositoryBase<CapGrouping>, ICapGroupingRepo
    {
        ...
        public CapGrouping GetByGroupingCode(String capGroupingCode)
        {
            try
            {
                return db.SingleOrDefault<CapGrouping>(" WHERE CAPGROUPING_CODE = @0 ", capGroupingCode.ToUpper());
            }
            catch (Exception ex)
            {
                // LOG EXCEPTION
        ...
        public IList<String> ActiveGroupingIdsForUserAndApplication(String userId, String applicationId)
        {
            var sql = Sql.Builder
                ...
                .Append(" AND UG.USER_ID = @0 ", userId.ToUpper())
                .Append(" AND G.APPLICATION_ID = @0", applicationId.ToUpper())
            ;
        ...
        public IList<String> ActiveGroupingIdsForApplication(String applicationId)
        {
            var sql = Sql.Builder
                ...
                .Append(" WHERE APPLICATION_ID = @0 AND IS_ACTIVE = 1", applicationId.ToUpper())
            ;
        ...
        public ISubCollection<CapGrouping> ListByApplication(String applicationId, Boolean onlyActive = false)
        {
            var sql = Sql.Builder
                ...
                .Append(" WHERE APPLICATION_ID = @0 ", applicationId.ToUpper())
            ;
        ...
        public Boolean IsUserMemberOfGrouping(String userId, String groupingId)
        {
            var sql = Sql.Builder
                ...
                .Append(" WHERE CAPGROUPING_ID = @0 AND USER_ID = @1 ", groupingId.ToUpper(), userId.ToUpper())
            ;
        ...
        public IList<String> ActiveGroupingCodesForUserAndApplication(String userId, String applicationId)
        {
            var sql = Sql.Builder
                ...
                .Append(" WHERE UG.USER_ID = @0 ", userId.ToUpper())
                .Append(" AND G.APPLICATION_ID = @0", applicationId.ToUpper())
            ;
        ...
        public IUpdateOperationResult SetUserGroupingAsMain(String groupingId, String userId, String applicationId)
        {
            try
            {
                var sql = Sql.Builder.Append(" UPDATE REVO_AUTH_USERS_CAPGROUPINGS ")
                                ...
                                .Append(" WHERE USER_ID = @0 ", userId.ToUpper())
                                .Append(" AND CAPGROUPING_ID IN ")
                                .Append(" (SELECT CAPGROUPING_ID FROM REVO_AUTH_CAPGROUPINGS WHERE APPLICATION_ID = @0) ", applicationId.ToUpper());
                            ;
                ...
                sql = Sql.Builder.Append(" UPDATE REVO_AUTH_USERS_CAPGROUPINGS ")
                                ...
                                .Append(" WHERE CAPGROUPING_ID = @0 AND USER_ID = @1 ", groupingId, userId.ToUpper());
        ...
        public ISubCollection<CapGrouping> ListByUser(String userId, Boolean onlyActive = false, Boolean onlyMain = false)
        {
            var sql = Sql.Builder
                ...
                .Append(" WHERE     UCG.USER_ID = @0", userId.ToUpper())
            ;
