...
{
    public interface IRettificaFuoriStandardRepo : IRepository<RettificaFuoriStandard>
    {
        ...
        ISubCollection<FuoriStandard> GetFuoriStandardFromIDs(List<String> IDFuoriStandard);
        ...
        ISubCollection<RettificaFuoriStandard> CercaRettificheDaApprovare(String CodGruppo);
        ISubCollection<RettificaFuoriStandard> CercaRettificheRifiutate(String CodGruppo);
        ISubCollection<FuoriStandard> CercaTutteLeRettifiche(String CodGruppo);
        ISubCollection<FuoriStandard> CercaRettificheDaApprovareByFilter(List<String> tipologie, String indicatore, String codRintracciabilita, String codCliente, DateTime dataInizio, DateTime dataFine, String inStandard, bool isProcessOwner);
        ...
        ISubCollection<RettificaSospensione> GetSospensioniByIDFuoriStandard(String FuoriStandardID);
